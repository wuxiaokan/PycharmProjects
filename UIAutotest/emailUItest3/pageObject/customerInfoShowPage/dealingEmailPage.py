...
class dealingEmailPage(customerInfoShowPage,dealingEmailPageLoc):
    ...
    def run_filterDealingEmailByEmailAct_case(self):
        self.dealingEmailPageCommon.selectEmailAct("789")
        ...
        self.dealingEmailPageCommon.selectEmailAct("fttx444")
        with allure.step("判断是否有邮件"):
